...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.osaka.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.osaka.state.state_root
    [Trie]: ref:ethereum.forks.osaka.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.osaka.trie.root
    [Trie]: ref:ethereum.forks.osaka.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.osaka.bloom.logs_bloom
    """
    ...
    [crh]: ref:ethereum.forks.osaka.requests.compute_requests_hash
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.osaka.blocks.Header
    [withdrawals]: ref:ethereum.forks.osaka.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.osaka.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.osaka.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.osaka.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.osaka.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.osaka.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.osaka.vm.instructions.log.log4
    """
